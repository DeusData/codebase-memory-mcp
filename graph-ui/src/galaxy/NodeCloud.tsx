 ...
 * feat/atlas-r1, Datei graph-ui/src/components/NodeCloud.tsx. Der Lizenztext
 ...
 *    durch Doppelpunkt oder Komma ersetzt.
 *  - Logik unveraendert: Punktschwelle, Kugel-Tessellierung, Farb- und
 *    Skalenrechnung und die beiden Raycast-Pfade sind Zeile fuer Zeile die
 *    des Originals.
 */
...
interface NodeCloudProps {
     ...
     * 0 = flat colors (dense graphs). Adaptive default x user setting. */
    boost?: number;
}
...
function NodeSpheres({
     ...
     * matrices only change with the node set or the highlight, never per frame. */
    useEffect(() => {
