...
REGISTRY_PATH = REPO_ROOT / "docs" / "benchmark-terminology.json"
...
def render_markdown(registry: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "<!-- Generated by scripts/generate-benchmark-terminology.py; do not edit. -->",
        "",
        f"- Terminology version: `{registry['terminology_version']}`",
        "- Canonical registry: `docs/benchmark-terminology.json`",
