#!/usr/bin/env bash
# search_graph.sh — Time search_graph name_pattern= queries against a
# codebase-memory-mcp binary to measure the regex / LIKE pre-filter performance.
#
# Usage:
#   benchmarks/search_graph.sh <binary-path> <project-name>
#
# Example:
#   benchmarks/search_graph.sh ./build/c/codebase-memory-mcp my-project
