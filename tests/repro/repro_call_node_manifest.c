...
static const CallNodeManifestEntry CALL_NODE_MANIFEST[] = {
    ...
    ENTRY(CBM_LANG_SYSTEMVERILOG, "subroutine_call", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
    ...
    ENTRY(CBM_LANG_LLVM_IR, "instruction_invoke", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
    ENTRY(CBM_LANG_LLVM_IR, "instruction_callbr", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
