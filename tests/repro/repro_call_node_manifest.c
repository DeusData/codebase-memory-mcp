...
static const CallNodeManifestEntry CALL_NODE_MANIFEST[] = {
    ...
    ENTRY(CBM_LANG_OBJECTSCRIPT_ROUTINE, "routine_tag_call", DIRECT_CALL, PRIMARY_EXTRACTOR, true,
          true),
    ENTRY(CBM_LANG_VISUALBASIC, "invocation", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
    ENTRY(CBM_LANG_VISUALBASIC, "new_expression", CONSTRUCTOR_CALL, PRIMARY_EXTRACTOR, true, true),
};
