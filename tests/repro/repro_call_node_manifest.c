...
enum {
    EXPECTED_HISTORICAL_CALL_NODE_TOTAL = 229,
    EXPECTED_ACTIVE_PRIMARY_TOTAL = 199,
    EXPECTED_DIRECT_CALLS = 163,
...
static const CallNodeManifestEntry CALL_NODE_MANIFEST[] = {
    ...
    ENTRY(CBM_LANG_VB6, "call_statement", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
    ENTRY(CBM_LANG_VB6, "call_expression", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
    ENTRY(CBM_LANG_VB6, "raise_event_statement", DIRECT_CALL, PRIMARY_EXTRACTOR, true, true),
};
