...
TEST(pipeline_gdscript_import_edge_persists_for_nested_preload_relative_path) {
    const char *files[] = {"addons/simple_import_plugin/plugin.gd",
    ...
    char file_qn[512];
    char module_qn[512];
    snprintf(file_qn, sizeof(file_qn), "%s.addons.simple_import_plugin.plugin.__file__", proj);
    snprintf(module_qn, sizeof(module_qn), "%s.addons.simple_import_plugin.import", proj);
