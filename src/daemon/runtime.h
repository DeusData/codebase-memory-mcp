...
/* #2178 heartbeat over the listener's runtime artifacts; see
 * cbm_daemon_ipc_listener_touch. Call only from the thread that stops and
 * frees the service, which is the only thread that closes the listener. */
