 ...
 *   cli [--json|--raw] <tool> <json>  Run a single tool call and print result
...
static int run_cli(int argc, char **argv) {
    ...
    (void)cli_strip_flag(&argc, argv, "--raw");
...
static void print_help(void) {
    ...
    printf("  codebase-memory-mcp cli [--json|--raw] <tool> [json]  Run a single tool\n");
