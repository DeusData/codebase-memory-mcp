...
int cbm_pipeline_run_incremental(cbm_pipeline_t *p, const char *db_path, cbm_file_info_t *files,
    ...
    cbm_log_info("incremental.classify", "changed", itoa_buf_incr(n_changed), "unchanged",
                 itoa_buf_incr(n_unchanged), "deleted", itoa_buf_incr(deleted_count));
    ...
    cbm_log_info("pass.timing", "pass", "incr_calls", "elapsed_ms",
                 itoa_buf_incr((int)elapsed_ms_incr(t)));

    cbm_clock_gettime(CLOCK_MONOTONIC, &t);
    cbm_pipeline_pass_usages(&ctx, changed_files, ci);
    cbm_log_info("pass.timing", "pass", "incr_usages", "elapsed_ms",
                 itoa_buf_incr((int)elapsed_ms_incr(t)));
    ...
    cbm_log_info("pass.timing", "pass", "incr_k8s", "elapsed_ms",
                 itoa_buf_incr((int)elapsed_ms_incr(t)));
    ...
    cbm_log_info("incremental.merged", "nodes", itoa_buf_incr(new_nodes), "edges",
                 itoa_buf_incr(new_edges));
