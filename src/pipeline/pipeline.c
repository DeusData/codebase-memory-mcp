...
static int run_sequential_pipeline(cbm_pipeline_t *p, cbm_pipeline_ctx_t *ctx,
    ...
    static const struct {
        ...
        {cbm_pipeline_pass_tcproj, "tcproj", true},
...
static int run_parallel_pipeline(cbm_pipeline_t *p, cbm_pipeline_ctx_t *ctx,
    ...
    cbm_clock_gettime(CLOCK_MONOTONIC, t);
    cbm_pipeline_pass_tcproj(ctx, files, file_count);
    cbm_log_info("pass.timing", "pass", "tcproj", "elapsed_ms", itoa_buf((int)elapsed_ms(*t)));
