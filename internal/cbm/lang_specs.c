...
static const char *iec_st_branch_types[] = {
    "if_statement",    "elsif_clause",     "case_clause", "for_statement",
    "while_statement", "repeat_statement", NULL};
static const char *iec_st_var_types[] = {"global_var_declaration_block", NULL};
static const char *iec_st_assign_types[] = {"assignment_statement",
                                            "reference_assignment_statement", NULL};
// ==================== SPEC TABLE ====================
...
static const CBMLangSpec lang_specs[CBM_LANG_COUNT] = {
    ...
    [CBM_LANG_IEC_ST] = {CBM_LANG_IEC_ST, iec_st_func_types, iec_st_class_types, iec_st_field_types,
                         iec_st_module_types, iec_st_call_types, iec_st_import_types,
                         iec_st_import_types, iec_st_branch_types, iec_st_var_types,
                         iec_st_assign_types, empty_types, NULL, empty_types, NULL, NULL,
