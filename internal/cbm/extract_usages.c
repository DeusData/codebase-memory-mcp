...
static bool is_value_field(const char *field) {
    return field && (strcmp(field, "value") == 0 || strcmp(field, "right") == 0 ||
                     ...
                     strcmp(field, "body") == 0 || strcmp(field, "arguments") == 0 ||
                     strcmp(field, "condition") == 0 || strcmp(field, "consequence") == 0 ||
                     strcmp(field, "alternative") == 0 || strcmp(field, "expression") == 0 ||
                     strcmp(field, "result") == 0);
}
